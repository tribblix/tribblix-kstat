...
/* Debug macros */
#define	DEBUG_ID "Tribblix::Kstat"
#ifdef KSTAT_DEBUG
...
#endif
#endif
/* The original divided by 1000000000.0, we keep the actual value */
#define	NEW_HRTIME(V) \
    newSVnv((NVTYPE) (V / 1.0))
 ...
 * Tribblix::Kstat::_Stat class, so that the appropriate TIEHASH methods are
...
get_tie(SV *self, char *module, int instance, char *name, int *is_new)
{
	...
	if (new) {
		...
		stash = gv_stashpv("Tribblix::Kstat::_Stat", TRUE);
 ...
 * deleted 1 will be returned, otherwise 0
 */
...
/* The following XS methods are the ABI of the Tribblix::Kstat package */

MODULE = Tribblix::Kstat PACKAGE = Tribblix::Kstat
PROTOTYPES: ENABLE
...
BOOT:
 ...
 #
 # The Tribblix::Kstat constructor.  This builds the nested
...
PPCODE:
 ...
 #
 # This returns the kstat chain id
 #
...
CODE:
 ...
 # visible to callers of the Tribblix::Kstat module
 #

MODULE = Tribblix::Kstat PACKAGE = Tribblix::Kstat::_Stat
PROTOTYPES: ENABLE
